...
const fileUploadUtil_1 = require("./rest/fileUploadUtil");
...
class BaseRestClient {
    ...
    constructor(restOptions = {}, networkOptions = {}) {
        ...
        this.globalRequestOptions = Object.assign(Object.assign({ 
            ...
            timeout: 1000 * 60 * 5 }, networkOptions), { headers: Object.assign(Object.assign({}, networkOptions.headers), { 'x-referer': (0, requestUtils_1.isEUAPIRegion)(this.options) ? requestUtils_1.APIIDEU : requestUtils_1.APIID }) });
        ...
        if (this.key && this.secret && !this.options.customSignMessageFn) {
            (0, webCryptoAPI_1.checkWebCryptoAPISupported)();
        }
    ...
    postPrivateFile(endpoint, params) {
        const isPublicAPI = false;
    ...
    buildRequest(method, url, params, isPublicApi, isFileUpload) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const signResult = yield this.prepareSignParams(method, isFileUpload ? 'v5authWithFile' : 'v5auth', params, isPublicApi);
     ...
     */
    _call(method, endpoint, params, isPublicApi, isFileUpload) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            // Sanity check to make sure it's only ever prefixed by one forward slash
            const requestUrl = [this.baseUrl, endpoint].join(endpoint.startsWith('/') ? '' : '/');
            // Build a request and handle signature process
            const options = yield this.buildRequest(method, requestUrl, params, isPublicApi, isFileUpload);
            if (ENABLE_HTTP_TRACE) {
                console.log('full request: ', isFileUpload
                    ? Object.assign(Object.assign({}, options), { data: `<binary data, ${(_a = options.data) === null || _a === void 0 ? void 0 : _a.length} bytes>` }) : options);
            }
            // Dispatch request
            return (0, axios_1.default)(options)
                ...
                if (response.status == 200) {
                    const perAPIRateLimits = this.options.parseAPIRateLimits
                        ...
                        : undefined;
                    const result = Object.assign({ rateLimitApi: perAPIRateLimits }, response.data);
    ...
    signMessage(paramsStr_1, secret_1, method_1) {
        return __awaiter(this, arguments, void 0, function* (paramsStr, secret, method, algorithm = 'SHA-256') {
    ...
    signRequest(data, method, signMethod) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (signMethod === 'v5authWithFile') {
                const { payload, contentType } = yield (0, fileUploadUtil_1.buildMultipartPayload)(data);
                ...
                res.sign = yield (0, webCryptoAPI_1.signBinaryData)(signBuffer, this.secret);
                // To ensure this goes in the request body
                res.originalParams = payload;
            ...
            if (signMethod === 'v5auth') {
                ...
                res.sign = yield this.signMessage(paramsStr, this.secret, undefined, // Let the function automatically determine encoding based on key type
                'SHA-256');

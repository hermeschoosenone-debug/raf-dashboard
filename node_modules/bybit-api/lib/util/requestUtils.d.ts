...
export type APIRegion = 'default' | 'bytick' | 'NL' | 'TK' | 'KZ' | 'HK' | 'GE' | 'UAE' | 'EU';
...
export declare const APIIDEU = "Cg000971";
/**
...
export declare function isEUAPIRegion(restClientOptions: RestClientOptions): boolean;

...
class WebsocketClient extends BaseWSClient_1.BaseWebsocketClient {
    constructor(options, logger) {
        super(Object.assign(Object.assign({}, options), { wsLoggerCategory: WS_LOGGER_CATEGORY_ID }), logger);
    }
    /**
    ...
    subscribe(requests, requestedWsKey) {
        ...
        const perWsKeyTopics = (0, util_1.getTopicsPerWSKey)(this.options.market, normalisedTopicRequests, requestedWsKey);
        // Batch sub topics per ws key
        for (const wsKey in perWsKeyTopics) {
            const wsKeyTopicRequests = (_a = perWsKeyTopics[wsKey]) === null || _a === void 0 ? void 0 : _a.filter((request) => {
                return !this.getWsStore().getMatchingTopic(wsKey, request);
            });
            if (wsKeyTopicRequests === null || wsKeyTopicRequests === void 0 ? void 0 : wsKeyTopicRequests.length) {
    ...
    sendWSAPIRequest() {
        return __awaiter(this, arguments, void 0, function* (wsKey = util_1.WS_KEY_MAP.v5PrivateTrade, operation, params, requestFlags) {
            var _a;
    ...
    triggerCustomReconnectionWorkflow() {
    ...
    getWsAuthSignature(wsKey) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const signature = yield this.signMessage('GET/realtime' + signatureExpiresAt, secret, undefined, // Let the function automatically determine encoding based on key type
            'SHA-256');
            return {
